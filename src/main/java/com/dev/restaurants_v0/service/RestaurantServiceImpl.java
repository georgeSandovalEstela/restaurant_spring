...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public String updateRestaurant(RestaurantsUpdateRequest restaurantsUpdateRequest) throws Exception {
        Optional<Restaurants> restaurantsOptional = restaurantRepository.findByIdAndState(restaurantsUpdateRequest.getId(), Integer.valueOf(Constants.STATE_INACTIVE));
